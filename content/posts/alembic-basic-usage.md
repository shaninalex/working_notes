...
To understand why this is happening read python documentation about module importing and what is goin on under the hood - [5. The import system](https://docs.python.org/3/reference/import.html).
